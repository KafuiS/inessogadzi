...
export default function About(): React.JSX.Element {
  ...
  const languagePath = isEnglish ? BASE_PATH : `${BASE_PATH}/en`;
  ...
  const title = isEnglish
    ? "Inès SOGADZI's Portfolio"
    : "Portfolio d' Inès SOGADZI";

  const description = isEnglish ? (
    <>
      It all started with fashion: a passion that gradually became an open door
      to image, design and creation.
      <br />
      <br />
      Throughout my journey, I have learned not only to create, but to think
      about ideas as a whole: from artistic direction to marketing, from content
      creation to project management.
      <br />
      <br />
      Today, I enjoy bridging strategy and creativity, always driven by the same
      desire: to turn a moment of attention into genuine engagement.
      <br />
    </>
  ) : (
    <>
      Tout a commencé avec la mode : une passion devenue peu à peu une porte
      ouverte vers l’image, le design et la création.
      <br />
      <br />
      Au fil de mon parcours, j’ai appris à ne plus seulement créer, mais à
      penser les idées dans leur ensemble : de la direction artistique au
      marketing, de la création de contenu à la gestion de projet.
      <br />
      <br />
      Aujourd’hui, j’aime faire le lien entre stratégie et création, avec
      toujours une même envie : transformer une seconde d’attention en véritable
      engagement.
      <br />
    </>
  );
    ...
    <>
      ...
      >
        ...
        <a
          href={homePath}
          className="logo"
          aria-label={isEnglish ? "Home" : "Accueil"}
        >
          <Image
