...
export default function Header({
  ...
  /* ========================================================= LANGUE ========================================================= */ const isEnglish =
    pathname.startsWith(`${BASE_PATH}/en`);
    ...
    <>
      ...
      <header className="site-header">
        ...
        <nav className="site-navigation" aria-label="Navigation principale">
          ...
          <a href={`${BASE_PATH}/galerie`}>WORK</a>{" "}
      ...
      >
        ...
        <div className="mobile-menu-content">
          ...
          <nav className="mobile-navigation" aria-label="Navigation mobile">
            {" "}
            <a href={BASE_PATH} onClick={() => setMenuOpen(false)}>
              {" "}
              ABOUT{" "}
            </a>{" "}
            <a href={`${BASE_PATH}/galerie`} onClick={() => setMenuOpen(false)}>
              {" "}
              WORK{" "}
            </a>{" "}
            <a
            ...
            <a href={`${BASE_PATH}/cv`} onClick={() => setMenuOpen(false)}>
              {" "}
              CV{" "}
            </a>{" "}
          </nav>{" "}
