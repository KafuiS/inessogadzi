...
const PROJECTS = 11;
/* ========================================================= GRILLE ========================================================= */ const IMAGE_SIZE = 155;
const GAP = 38;
const STEP_X = IMAGE_SIZE + GAP;
const STEP_Y = IMAGE_SIZE + GAP;
/* ========================================================= COURBURE ========================================================= */ const CURVE_HORIZONTAL = 0.0000000001;
const CURVE_VERTICAL = 0.000000001;
/* ========================================================= MOUVEMENT ========================================================= */ const FOLLOW = 0.16;
const FRICTION = 0.91;
const DRAG_MULTIPLIER = 1.35;
/* ========================================================= ZOOM ========================================================= */ const BASE_SCALE = 1;
...
/* ========================================================= FOND ========================================================= */ const BACKGROUND =
  "#111111";
/* ========================================================= GRAIN ========================================================= */ const GRAIN_CONTRAST = 1.0;
const GRAIN_SAMPLES = 3;
/* ========================================================= TYPOGRAPHIE SURVOL ========================================================= */ const HOVER_FONT_SIZE = 20;
const HOVER_LETTER_SPACING = 1;
/* ========================================================= DONNÉES ========================================================= */ type ProjectData =
  {
    title: string;
    type: string;
    role: string;
  ...
  1: {
    ...
    description: (
      <>
        ...
        alphabet, de A à Z, ainsi qu’une série de chiffres de 1 à 9. <br />{" "}
        <br /> J’ai travaillé sur un contraste marqué entre des empattements
        imposants et des lignes très fines, en cherchant à trouver un équilibre
...
/* ========================================================= URLS ========================================================= */ const PROJECT_URLS: Record<
  number,
  string
> = {
  2: "",
  3: "../projects/zen.mp4",
  4: "../projects/resistif.mp4",
  5: "../projects/noises.mp4",
  6: "../projects/virgil.pdf",
  7: "../projects/windmap.pdf",
  8: "../projects/charte-ministere-temps.pdf",
  9: "https://trot.mastercmw.com/",
  10: "https://sevran-en-mouvement.mastercmw.com/accueil/",
  11: "#",
};
/* ========================================================= TYPES ========================================================= */ type ProjectModalProps =
...
/* ========================================================= MÉDIAS ========================================================= */ function getProjectMedia(
  projectIndex: number,
): ProjectMedia[] {
  if (projectIndex === 2) {
    return [
      { type: "image", src: "/projects/project-2.jpg" },
  ...
  if (projectIndex === 11) {
    return [
      { type: "video", src: "/projects/project-11-1.mp4" },
      { type: "video", src: "/projects/project-11-2.mp4" },
      { type: "image", src: "/projects/project-11-1.jpg" },
      { type: "image", src: "/projects/project-11-2.jpg" },
      { type: "image", src: "/projects/project-11-digital-1.jpg" },
      { type: "image", src: "/projects/project-11-digital-2.jpg" },
      { type: "image", src: "/projects/project-11-digital-3.jpg" },
    ];
  }
  return [
    { type: "image", src: `/projects/project-${projectIndex}.jpg` },
    { type: "image", src: `/projects/project-${projectIndex}-2.jpg` },
    { type: "image", src: `/projects/project-${projectIndex}-3.jpg` },
  ];
}
...
/* ========================================================= GRAIN DU POPUP ========================================================= */ function PopupGrain(): React.JSX.Element {
...
/* ========================================================= ICÔNE VOLUME ========================================================= */ function VolumeIcon({
  muted,
}: {
  muted: boolean;
}): React.JSX.Element {
        ...
        <div className="project-modal-main">
          ...
          <div className="project-modal-copy">
            ...
            <div className="project-modal-meta">
              {" "}
              <div>{project.type}</div> <div>{project.role}</div>{" "}
      ...
      <style jsx>{`
        ...
        @media (max-width: 600px) {
          ...
          .project-modal-video {
            ...
            max-height: 45vh;
            object-fit: contain;
          } /* * Les flèches restent dans la fenêtre : * elles sont attachées à la zone média et non au viewport. */
          .project-carousel-arrow {
            position: absolute;
            top: 50%;
            width: 34px;
...
/* ========================================================= GALERIE ========================================================= */ export default function Galerie(): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    for (let i = 1; i <= PROJECTS; i += 1) {
      if (i === 11) {
        ...
        video.src = "/projects/project-11-1.mp4";
        video.muted = true;
        ...
        void video.play().catch(() => {});
        images.push({ index: i, video });
      } else {
        const image = new window.Image();
        image.src = `/projects/project-${i}.jpg`;
    ...
    function deform(x: number, y: number): { x: number; y: number } {
      const dx = x - centerX;
      const dy = y - centerY;
      return {
